            ...
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li><a href="index.php?AddBrand" target="_blank">Add Brand</a></li>
                            <li><a href="index.php?ViewBrand" target="_blank">View Brand</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span class="pcoded-mtext">User</span></a>
                        <ul class="pcoded-submenu">
                    ...
                    <li class="nav-item pcoded-hasmenu">
                        <a href="#!" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-layout"></i></span><span
                                class="pcoded-mtext">Shopping</span></a>
                        <ul class="pcoded-submenu">
